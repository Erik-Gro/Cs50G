...
function Pokemon:statsLevelUp()
    local HPIncrease = 0
    local hp, atc, dfns, spd = self.HP, self.attack, self.defense, self.speed
    for j = 1, 3 do
    ...
    return { { HPIncrease, hp, 'health' }, { attackIncrease, atc, 'attack' }, { defenseIncrease, dfns, 'defense' }, { speedIncrease, spd, 'speed' } }
end
