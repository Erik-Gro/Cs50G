...
gTextures = {
    ...
    ['flagtop'] = love.graphics.newImage('graphics/flags.png'),
}
...
gFrames = {
    ...
    ['flag'] = GenerateQuads(gTextures['flag'], 16, 54),
    ['flagtop'] = GenerateQuads(gTextures['flag'], 16, 16),
}
...
LockKeyPais = {
    { gFrames['keys-locks'][1], gFrames['keys-locks'][4] },
    { gFrames['keys-locks'][2], gFrames['keys-locks'][5] },
    { gFrames['keys-locks'][3], gFrames['keys-locks'][6] }
}
